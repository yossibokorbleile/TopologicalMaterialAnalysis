...
def compute():
	...
	for s in range(st.session_state.sample_start, st.session_state.sample_end, st.session_state.sample_step):
		...
		if st.session_state.params.kernel or st.session_state.params.image or st.session_state.params.cokernel:
			...
			st.session_state.APFs_0.append(calculate_APF(st.session_state.dgm_0))
			st.session_state.APFs_1.append(calculate_APF(st.session_state.dgm_1))
			st.session_state.APFs_2.append(calculate_APF(st.session_state.dgm_2))
			if st.session_state["kernel"] or st.session_state["image"] or st.session_state["cokernel"]:
				st.session_state.kicrs.append(st.session_state.kicr)
			if st.session_state["kernel"]:
				...
				st.session_state.kernel_APFs_0.append(calculate_APF(kernel_dgm_0))
				st.session_state.kernel_APFs_1.append(calculate_APF(kernel_dgm_1))
				st.session_state.kernel_APFs_2.append(calculate_APF(kernel_dgm_2))
			if st.session_state["image"]:
				...
				st.session_state.image_APFs_0.append(calculate_APF(image_dgm_0))
				st.session_state.image_APFs_1.append(calculate_APF(image_dgm_1))
				st.session_state.image_APFs_2.append(calculate_APF(image_dgm_2))
			if st.session_state["cokernel"]:
				...
				st.session_state.cokernel_APFs_0.append(calculate_APF(cokernel_dgm_0))
				st.session_state.cokernel_APFs_1.append(calculate_APF(cokernel_dgm_1))
				st.session_state.cokernel_APFs_2.append(calculate_APF(cokernel_dgm_2))
		else:
