...
pg = st.navigation([welcome_page, single_mode, multi_mode, license_page])#[st.Page("welcome.py", title="ToMA"), st.Page("single_mode.py", title="Single Mode"), st.Page("license.py", title="License")])
pg.run()